...
export const en = {
  ...
  "models.customFieldMaxOutput": "Maximum output tokens",
  "models.customFieldMaxOutputPlaceholder": "e.g. 128000",
  "models.customFieldMaxOutputInvalid": "Maximum output tokens must be a positive integer.",
  ...
  "models.tipMaxOutput": "Max output",
 ...
 "modal.baseUrlPlaceholder": "https://...",
  ...
  "integrations.codex.body": "Choose whether opencodex manages Codex fully, refreshes only its model catalog, or stays off.",
  "integrations.codex.modeLabel": "Integration mode",
  "integrations.codex.mode.full": "Full",
  "integrations.codex.mode.catalogOnly": "Catalog only",
  "integrations.codex.mode.off": "Off",
  "integrations.codex.modeDescription.full": "opencodex manages Codex routing, model catalog, cache, and compatibility artifacts.",
  "integrations.codex.modeDescription.catalogOnly": "opencodex refreshes the model picker catalog and cache while preserving provider routing and history.",
  "integrations.codex.modeDescription.off": "opencodex does not manage Codex routing or its model catalog.",
  ...
  "integrations.detail.codexCatalogOnly": "Model picker managed; routing and history unchanged",
  ...
  "integrations.error.change": "The Codex integration change failed. Your previous mode was kept.",
  ...
  "api.clientConfig.missingLimits": "{count} of {total} model(s) ship without complete supported limit metadata; the client applies its own defaults.",
