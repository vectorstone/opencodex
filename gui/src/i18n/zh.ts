...
"common.discard": "丢弃",
  ...
  "models.customFieldMaxOutput": "最大输出 token",
  "models.customFieldMaxOutputPlaceholder": "例如 128000",
  "models.customFieldMaxOutputInvalid": "最大输出 token 必须是正整数。",
...
"codexSet.dialog.notRendered": "在我们读取的那一轮中，此层没有发送任何内容。各部分仅在内容变化时才会重新发送，因此单次采样可能看不到它。",
  ...
  "integrations.codex.modeLabel": "集成模式",
  "integrations.codex.mode.full": "完整",
  "integrations.codex.mode.catalogOnly": "仅目录",
  "integrations.codex.mode.off": "关闭",
  "integrations.codex.modeDescription.full": "opencodex 管理 Codex 路由、模型目录、缓存及兼容性文件。",
  "integrations.codex.modeDescription.catalogOnly": "opencodex 只刷新模型选择器目录和缓存，并保留现有提供商路由与历史记录。",
  "integrations.codex.modeDescription.off": "opencodex 不管理 Codex 路由或模型目录。",
  ...
  "integrations.detail.codexCatalogOnly": "模型选择器已管理；路由和历史保持不变",
  ...
  "integrations.error.change": "Codex 集成修改失败，已保留之前的模式。",
  ...
  "api.clientConfig.missingLimits": "{total} 个模型中有 {count} 个缺少客户端支持的完整限制元数据，客户端将使用自己的默认值。",
