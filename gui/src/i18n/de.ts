...
"common.discard": "Verwerfen",
  ...
  "models.customFieldMaxOutput": "Maximale Ausgabetokens",
  "models.customFieldMaxOutputPlaceholder": "z. B. 128000",
  "models.customFieldMaxOutputInvalid": "Die maximale Ausgabetokenzahl muss eine positive Ganzzahl sein.",
  ...
  "models.tipMaxOutput": "Max. Ausgabe",
...
"codexSet.dialog.notRendered": "In der gelesenen Runde hat diese Ebene nichts gesendet. Abschnitte werden nur bei Änderungen erneut gesendet, daher kann eine einzelne Stichprobe sie nicht enthalten.",
  ...
  "integrations.codex.modeLabel": "Integrationsmodus",
  "integrations.codex.mode.full": "Vollständig",
  "integrations.codex.mode.catalogOnly": "Nur Katalog",
  "integrations.codex.mode.off": "Aus",
  "integrations.codex.modeDescription.full": "opencodex verwaltet Codex-Routing, Modellkatalog, Cache und Kompatibilitätsartefakte.",
  "integrations.codex.modeDescription.catalogOnly": "opencodex aktualisiert Modellkatalog und Cache, während Provider-Routing und Verlauf erhalten bleiben.",
  "integrations.codex.modeDescription.off": "opencodex verwaltet weder Codex-Routing noch den Modellkatalog.",
  ...
  "integrations.detail.codexCatalogOnly": "Modellauswahl verwaltet; Routing und Verlauf unverändert",
  ...
  "integrations.error.change": "Die Änderung der Codex-Integration ist fehlgeschlagen. Der vorherige Modus bleibt erhalten.",
  ...
  "api.clientConfig.missingLimits": "{count} von {total} Modell(en) haben keine vollständigen unterstützten Limit-Metadaten; der Client verwendet eigene Vorgaben.",
