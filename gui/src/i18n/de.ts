...
export const de: Record<TKey, string> = {
  ...
  "integrations.codex.body": "Wählen Sie, ob opencodex das Codex-Routing vollständig verwaltet, nur den Modellkatalog pflegt oder die Integration deaktiviert.",
  ...
  "integrations.codex.modeDescription.full": "opencodex verwaltet Codex-Routing, Modellkatalog, Cache und Kompatibilitätsdateien.",
  "integrations.codex.modeDescription.catalogOnly": "opencodex aktualisiert Modellkatalog und Cache, während Provider-Routing und Verlauf unverändert bleiben.",
  "integrations.codex.modeDescription.off": "opencodex verwaltet weder Codex-Routing noch Modellkatalog.",
