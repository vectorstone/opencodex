...
export const ko: Record<TKey, string> = {
  ...
  "models.customFieldMaxOutput": "최대 출력 토큰",
  "models.customFieldMaxOutputPlaceholder": "예: 128000",
  "models.customFieldMaxOutputInvalid": "최대 출력 토큰은 양의 정수여야 합니다.",
  ...
  "integrations.codex.modeLabel": "통합 모드",
  "integrations.codex.mode.full": "전체",
  "integrations.codex.mode.catalogOnly": "카탈로그만",
  "integrations.codex.mode.off": "끔",
  "integrations.codex.modeDescription.full": "opencodex가 Codex 라우팅, 모델 카탈로그, 캐시 및 호환성 아티팩트를 관리합니다.",
  "integrations.codex.modeDescription.catalogOnly": "프로바이더 라우팅과 기록은 유지하면서 모델 선택기 카탈로그와 캐시만 갱신합니다.",
  "integrations.codex.modeDescription.off": "opencodex가 Codex 라우팅이나 모델 카탈로그를 관리하지 않습니다.",
  ...
  "integrations.detail.codexCatalogOnly": "모델 선택기 관리됨; 라우팅과 기록은 변경되지 않음",
  ...
  "integrations.error.change": "Codex 통합 변경에 실패했습니다. 이전 모드를 유지합니다.",
  ...
  "api.clientConfig.missingLimits": "{total}개 중 {count}개 모델에 지원되는 전체 한도 메타데이터가 없어 클라이언트 기본값이 적용됩니다.",
