...
export const ko: Record<TKey, string> = {
  ...
  "integrations.codex.body": "opencodex가 Codex 라우팅을 완전히 관리할지, 모델 카탈로그만 갱신할지, 통합을 끌지 선택합니다.",
  ...
  "integrations.codex.modeDescription.full": "opencodex가 Codex 라우팅, 모델 카탈로그, 캐시 및 호환성 파일을 관리합니다.",
  "integrations.codex.modeDescription.catalogOnly": "공급자 라우팅과 기록은 유지하면서 모델 선택기 카탈로그와 캐시만 갱신합니다.",
  ...
  "integrations.detail.codexCatalogOnly": "모델 선택기 관리 중, 라우팅과 기록은 변경 없음",
