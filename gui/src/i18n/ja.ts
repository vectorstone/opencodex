...
export const ja: Record<TKey, string> = {
  ...
  "integrations.codex.modeLabel": "連携モード",
  "integrations.codex.mode.full": "完全",
  "integrations.codex.mode.catalogOnly": "カタログのみ",
  "integrations.codex.mode.off": "オフ",
  "integrations.codex.modeDescription.full": "opencodex が Codex のルーティング、モデルカタログ、キャッシュ、互換性アーティファクトを管理します。",
  "integrations.codex.modeDescription.catalogOnly": "プロバイダーのルーティングと履歴を維持したまま、モデルカタログとキャッシュのみを更新します。",
  "integrations.codex.modeDescription.off": "opencodex は Codex のルーティングもモデルカタログも管理しません。",
  ...
  "integrations.detail.codexCatalogOnly": "モデル選択を管理中、ルーティングと履歴は変更なし",
  ...
  "integrations.error.change": "Codex 連携の変更に失敗しました。以前のモードを維持します。",
  ...
  "api.clientConfig.missingLimits": "{total} 件中 {count} 件のモデルに、対応する完全な上限メタデータがないため、クライアント側の既定値が使われます。",
  ...
  "models.customFieldMaxOutput": "最大出力トークン数",
  "models.customFieldMaxOutputPlaceholder": "例: 128000",
  "models.customFieldMaxOutputInvalid": "最大出力トークン数は正の整数である必要があります。",
