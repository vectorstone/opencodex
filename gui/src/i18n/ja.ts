...
export const ja: Record<TKey, string> = {
  ...
  "integrations.codex.body": "opencodex が Codex を完全に管理するか、モデルカタログのみを更新するか、連携をオフにするかを選択します。",
  ...
  "integrations.codex.modeDescription.full": "opencodex が Codex のルーティング、モデルカタログ、キャッシュ、互換性ファイルを管理します。",
  "integrations.codex.modeDescription.catalogOnly": "プロバイダーのルーティングと履歴を維持したまま、モデル選択カタログとキャッシュのみを更新します。",
