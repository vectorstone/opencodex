...
export const ru: Record<TKey, string> = {
  ...
  "integrations.codex.body": "Выберите: полное управление Codex через opencodex, обновление только каталога моделей или отключение интеграции.",
  ...
  "integrations.codex.modeDescription.full": "opencodex управляет маршрутизацией Codex, каталогом моделей, кэшем и файлами совместимости.",
  "integrations.codex.modeDescription.catalogOnly": "opencodex обновляет каталог выбора моделей и кэш, сохраняя маршрутизацию провайдера и историю.",
  "integrations.codex.modeDescription.off": "opencodex не управляет маршрутизацией Codex и каталогом моделей.",
  ...
  "integrations.detail.codexCatalogOnly": "Каталог моделей управляется; маршрутизация и история без изменений",
